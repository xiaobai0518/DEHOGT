...
#Simulation setting 2 for negative Binominal: 
...
for (iter in 1: 50){
  ...
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(0.1, 0.2))
  data = output$data
...
write.matrix(fpr_mat, "setting2_fpr.txt")
write.matrix(fnr_mat, "setting2_fnr.txt")
write.matrix(pp_mat, "setting2_pp.txt")
write.matrix(auc_mat, "setting2_auc.txt")

#Simulation setting 2 for negative Binominal:
#dispersion: 0.2 - 1, repeat 50 times, log2foldchange adjusted at 1.5, pvalue cutoff 0.05
fpr_mat = matrix(rep(0, 50 * 3), nrow=50)
fnr_mat = matrix(rep(0, 50 * 3), nrow=50)
pp_mat = matrix(rep(0, 50 * 3), nrow=50)
auc_mat = matrix(rep(0, 50 * 3), nrow=50)
...
for (iter in 1: 50){
  ...
  ## generate data and true DE genes
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(0.2, 1))
  data = output$data
  idx_true = rep(0, 12500)
  idx_true[output$DE_up_idx] = 1
  treatment = factor(c(rep(1, 6), rep(2, 6)))
...
#Simulation setting 2 for negative Binominal: 
#dispersion: 1 - 2, repeat 50 times, log2foldchange adjusted at 1.5, pvalue cutoff 0.05
fpr_mat = matrix(rep(0, 50 * 3), nrow=50)
fnr_mat = matrix(rep(0, 50 * 3), nrow=50)
pp_mat = matrix(rep(0, 50 * 3), nrow=50)
auc_mat = matrix(rep(0, 50 * 3), nrow=50)
...
for (iter in 1: 50){
  ...
  ## generate data and true DE genes
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(1, 2))
  data = output$data
  idx_true = rep(0, 12500)
  idx_true[output$DE_up_idx] = 1
  treatment = factor(c(rep(1, 6), rep(2, 6)))
...
#Simulation setting 2 for quasi-Poisson: 
...
for (iter in 1: 50){
  ...
  ## generate data and true DE genes
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(10, 20), dist = "qpois")
  data = output$data
  idx_true = rep(0, 12500)
  idx_true[output$DE_up_idx] = 1
  treatment = factor(c(rep(1, 6), rep(2, 6)))
...
#Simulation setting 2 for quasi-Poisson: 
#dispersion: 20 - 50, repeat 50 times, log2foldchange adjusted at 1.5, pvalue cutoff 0.05
fpr_mat = matrix(rep(0, 50 * 3), nrow=50)
fnr_mat = matrix(rep(0, 50 * 3), nrow=50)
pp_mat = matrix(rep(0, 50 * 3), nrow=50)
auc_mat = matrix(rep(0, 50 * 3), nrow=50)
...
for (iter in 1: 50){
  ...
  ## generate data and true DE genes
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(20, 50), dist = "qpois")
  data = output$data
  idx_true = rep(0, 12500)
  idx_true[output$DE_up_idx] = 1
  treatment = factor(c(rep(1, 6), rep(2, 6)))
...
#Simulation setting 2 for quasi-Poisson: 
#dispersion: 50 - 100, repeat 50 times, log2foldchange adjusted at 1.5, pvalue cutoff 0.05
fpr_mat = matrix(rep(0, 50 * 3), nrow=50)
fnr_mat = matrix(rep(0, 50 * 3), nrow=50)
pp_mat = matrix(rep(0, 50 * 3), nrow=50)
auc_mat = matrix(rep(0, 50 * 3), nrow=50)
...
for (iter in 1: 50){
  ...
  ## generate data and true DE genes
  output = sim_data2(12500, 2500, 0, 6, 6, dispersion = c(50, 100), dist = "qpois")
  data = output$data
  idx_true = rep(0, 12500)
  idx_true[output$DE_up_idx] = 1
  treatment = factor(c(rep(1, 6), rep(2, 6)))
